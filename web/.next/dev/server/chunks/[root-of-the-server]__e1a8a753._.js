...
"[project]/pages/api/ai-interview/answer.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    if (!interviewId || !answer) {
        return res.status(400).json({
            error: "Missing interviewId or answer"
        });
    }
    try {
        const session = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$ai$2d$interview$2f$sessionStore$2e$js__$5b$api$5d$__$28$ecmascript$29$__["getSession"])(interviewId);
        if (!session) {
        ...
        if (response.interviewComplete) {
            setTimeout(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$ai$2d$interview$2f$sessionStore$2e$js__$5b$api$5d$__$28$ecmascript$29$__["deleteSession"])(interviewId), 5 * 60 * 1000);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e1a8a753._.js.map